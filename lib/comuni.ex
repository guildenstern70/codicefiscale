...
defmodule Comuni do
  ...
  def find_comune(comune) do
    ...
    {:ok, statement} =
      ...
      SELECT * FROM comuni WHERE comune = ? COLLATE NOCASE
  ...
  defp comune_from_text_line(text) do
    [istat, nome, provincia, regione, prefisso, cap, codice, _abitanti, _link] =
      String.split(text, ";")

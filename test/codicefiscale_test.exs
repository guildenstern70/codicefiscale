...
defmodule CodicefiscaleTest do
  ...
  test "Raises ArgumentError for non-existent birth place" do
    person = %{
      name: "Lucilla",
      surname: "Gaspari",
      birth_date: ~D[1975-03-23],
      birth_place: "NonExistentCity",
      gender: :female
    }

    assert_raise ArgumentError, ~r/Birth place 'NonExistentCity' not found/, fn ->
      Codicefiscale.compute(person)
    end
  end
